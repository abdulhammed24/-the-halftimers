          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-600">
                ...
                Repellat dolore sit beatae tempora laudantium iusto quis minima
                quisquam, nobis reprehenderit. Corporis rerum consectetur ut
                laudantium adipisci facere accusantium nam non?
              </p>
            </div>
          </div>
        </div>
